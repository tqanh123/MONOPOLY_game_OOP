...
public class Places {
    ...
    public void draw(Graphics2D g2) {
        ...
        lands[0] = new LandButton(gp, "a", 0, 0, r, 120, 240, gp.originalTileSize*8, 0);

        int r2[] = {14, 50, 100, 300, 600, 850};
        lands[1] = new LandButton(gp, "b", 0, 0, r2, 140, 280, gp.originalTileSize*12, 0);
