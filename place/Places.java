...
public class Places extends placeDraw {
    ...
    public void getBackGroundImage() {
        ...
        lands[4] = new StationButton(gp, 4,"MARYLEBONE STATION", 0, r23, 500, 250, gp.LandWidth*4 + gp.LandHeight, 705, width, height, false);

        int r24[] = {50, 100, 200, 400};
        lands[14] = new StationButton(gp, 14, "FENCHURCH STATION", 0, r24, 700, 350, 0, 343, height, width, false);

        int r25[] = {50, 100, 200, 400};
        lands[23] = new StationButton(gp, 23, "KING CROSS STATION", 0, r25, 1000, 500, 415, 0, width, height, false);

        int r26[] = {50, 100, 200, 400};
        lands[32] = new StationButton(gp, 32, "LIVERPOOL ST. STATION", 0, r26, 1500, 750, 705, 415, height, width, false);
